...
const Home = () => {
    ...
    const categoriesList = ['All', 'Technology', 'Music', 'Business', 'Art'];
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between mb-8 px-2 gap-4 border-b border-gray-200 pb-6">
                <div>
                    <h2 className="text-3xl font-extrabold text-gray-900 mb-1">Upcoming Events</h2>
                    <div className="text-gray-500 font-medium text-sm">{sortedEvents.length} results found</div>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        {categoriesList.map(cat => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-full text-xs font-bold transition ${category === cat
                    ...
                    <select
                        ...
                        className="bg-white border border-gray-200 rounded-lg px-3 py-2 text-xs font-semibold text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-700"
                    >
