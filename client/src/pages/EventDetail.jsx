                    ...
                    <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 min-w-[300px] w-full md:w-auto shrink-0 shadow-sm">
                        ...
                        {event.ticketPrice > 0 && (
                            <div className="mb-6 pt-4 border-t border-gray-200">
                                <label className="block text-xs font-bold text-gray-500 uppercase mb-2">Preferred Payment Method</label>
                                <div className="grid grid-cols-3 gap-2">
                                    <button
                                        type="button"
                                        onClick={() => setPaymentMethod('card')}
                                        className={`py-2 text-xs font-bold rounded-lg border transition ${paymentMethod === 'card' ? 'bg-gray-900 text-white border-gray-900' : 'bg-white text-gray-700 border-gray-200 hover:bg-gray-100'}`}
                                    >
                                        💳 Card
                                    </button>
                                    <button
                                        ...
                                        className={`py-2 text-xs font-bold rounded-lg border transition ${paymentMethod === 'upi' ? 'bg-gray-900 text-white border-gray-900' : 'bg-white text-gray-700 border-gray-200 hover:bg-gray-100'}`}
                                    >
                                        📱 UPI
                                    </button>
                                    <button
                                        ...
                                        className={`py-2 text-xs font-bold rounded-lg border transition ${paymentMethod === 'netbanking' ? 'bg-gray-900 text-white border-gray-900' : 'bg-white text-gray-700 border-gray-200 hover:bg-gray-100'}`}
                                    >
                                        🏦 Net Banking
                                    </button>
                                </div>
