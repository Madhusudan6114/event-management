            ...
            {showEventForm && (
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 mb-8 animation-slideDown">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-2xl font-bold text-gray-800">{editingEventId ? 'Edit Event' : 'Create New Event'}</h2>
                        {editingEventId && (
                            <button type="button" onClick={handleCancelForm} className="text-sm font-semibold text-gray-500 hover:text-gray-700">Cancel Edit</button>
                        )}
                    </div>
                    <form onSubmit={handleFormSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <button type="submit" className="md:col-span-2 bg-gray-900 text-white font-bold py-3 mt-2 rounded-lg hover:bg-black transition shadow-md">
                                ...
                                events.map(event => (
                                    <li key={event._id} className="p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 hover:bg-gray-50 transition border-b border-gray-100 last:border-0">
                                        ...
                                        <div className="flex items-center gap-2 w-full sm:w-auto shrink-0">
                                            <button onClick={() => handleEditClick(event)} className="flex-1 sm:flex-none text-gray-700 hover:text-black hover:bg-gray-100 border border-gray-300 px-3 py-1.5 rounded-lg text-sm font-bold transition shadow-sm">
                                                Edit
                                            </button>
                                            <button onClick={() => handleDeleteEvent(event._id)} className="flex-1 sm:flex-none text-red-500 hover:text-white hover:bg-red-500 border border-red-200 px-3 py-1.5 rounded-lg text-sm font-bold transition shadow-sm">
                                                Delete
                                            </button>
                                        </div>
                                    </li>
